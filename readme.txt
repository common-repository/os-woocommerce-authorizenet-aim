...
Tags: Authorize.net, Authorize.net Gateway, Payment, Payment gateway, credicard pay, credit card
...
So that others can share in the answer, please submit your support requests through the WordPress forums for Authorize.net for WooCommerce(http://wordpress.org/support/plugin/os-woocommerce-authorizenet-aim).
...
2. Search for "os-woocommerce-authorizenet-aim"
3. Click "install"
4. Activate the plugin once it is installed

FTP upload installation method:

1. Upload the `os-woocommerce-authorizenet-aim` folder to the `/wp-content/plugins/` directory using your FTP client
...
4. Click **Choose file** (**Browse**) and select the os-woocommerce-authorizenet-aim.*.zip file.   
...
1. First Data admin settings 1.
2. First Data admin settings 2.
3. Screenshot from checkout page
